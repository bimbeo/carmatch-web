    ...
    <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden hover:shadow-md hover:border-gray-200 transition-all group">
      ...
      <div className="relative overflow-hidden aspect-video bg-gray-100">
        ...
        {car.popular && (
          <div className="absolute top-3 right-3">
            <span className="px-2.5 py-1 bg-green-600 text-white rounded-full text-xs font-semibold shadow-sm">
              Phổ biến
            </span>
          </div>
        )}
      ...
      <div className="p-4">
        ...
        <div className="flex items-baseline gap-1.5 mb-4">
          <span className="text-green-600 font-bold text-lg">{formatPrice(car.price)}</span>
        ...
        <div className="flex gap-2">
          ...
          <a
            ...
            className="flex-1 py-2.5 text-center text-sm font-semibold bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors flex items-center justify-center gap-1.5"
          >

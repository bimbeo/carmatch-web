      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-[#0068FF]/20 flex items-center justify-center hover:bg-[#0068FF]/30 transition-colors"
              >
                <span className="text-[#0068FF] text-xs font-bold">Z</span>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item.href}>
                  <Link to={item.href} className="text-gray-500 text-sm hover:text-gray-300 transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <Phone className="w-4 h-4 mt-0.5 shrink-0 group-hover:text-[#4ade80] transition-colors" />
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-gray-500 hover:text-gray-300 transition-colors group"
                >
                  <span className="w-4 h-4 mt-0.5 shrink-0 text-[#0068FF] font-bold text-xs leading-none">Z</span>
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-gray-500 hover:text-gray-300 transition-colors group"
                >
                  <Mail className="w-4 h-4 mt-0.5 shrink-0 group-hover:text-[#4ade80] transition-colors" />
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-xs">
            © 2025 CarMatch. Bảo lưu mọi quyền.
          </p>
          <div className="flex items-center gap-6">
            <Link to="/gioi-thieu#chinh-sach" className="text-gray-600 text-xs hover:text-gray-400 transition-colors">
              Chính sách
            </Link>
            <Link to="/gioi-thieu#dieu-khoan" className="text-gray-600 text-xs hover:text-gray-400 transition-colors">
              Điều khoản
            </Link>
          </div>
        </div>

...
export function buildVehicleReservationInsert({
  companyId,
  vehicleId,
  pickupAt,
  returnAt,
...
export default async function handler(req, res) {
  ...
  if (!requiresConfirmation) {
    ...
    const reservationPayload = buildVehicleReservationInsert({
      companyId,
      vehicleId: vehicle.id,
      pickupAt,
      returnAt,
    ...
    const { data: reservation, error: holdError } = await supabase

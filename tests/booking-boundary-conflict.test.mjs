...
test('lets Postgres generate the reservation rental period', () => {
  const payload = buildVehicleReservationInsert({
    companyId: 'company-1',
    vehicleId: 'vehicle-1',
    pickupAt: new Date('2026-08-04T01:00:00.000Z'),
    returnAt: new Date('2026-08-05T13:00:00.000Z'),
    activeUntil: '2026-08-25T03:15:00.000Z',
    bookingRef: 'CMOTTL260825-BWTEST',
    idempotencyKey: 'booking-test-key-1234',
  });

  assert.equal(Object.hasOwn(payload, 'rental_period'), false);
  assert.deepEqual(payload, {
    company_id: 'company-1',
    vehicle_id: 'vehicle-1',
    status: 'held',
    starts_at: '2026-08-04T01:00:00.000Z',
    ends_at: '2026-08-05T13:00:00.000Z',
    active_until: '2026-08-25T03:15:00.000Z',
    source: 'website',
    metadata: {
      booking_ref: 'CMOTTL260825-BWTEST',
      idempotency_key: 'booking-test-key-1234',
    },
  });
});
